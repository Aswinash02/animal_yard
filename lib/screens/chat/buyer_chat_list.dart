...
class BuyerChatList extends StatefulWidget {
  ...
  @override
  State<BuyerChatList> createState() => _BuyerChatListState();
}
...
class _BuyerChatListState extends State<BuyerChatList> {
  ...
  clearData() {
    ...
    controller.buyerFaceData.value = false;
  }
          ...
          SliverToBoxAdapter(
            child: Obx(() {
              return Container(
                ...
                child: controller.buyerFaceData.value
                    ? buildChatListView()
                    : chatListShimmer(),
              );
            }),
  ...
  Widget buildChatListView() {
    return Obx(() {
      return controller.buyerLoadingState.value
          ? chatListShimmer()
                  ...
                  itemBuilder: (context, index) {
                    return Container(
                        ...
                        child: buildChatItem(
                          ...
                          true,
                          controller.buyerChatList[index].unReadCustomer ?? 0,
                          controller.buyerChatList[index].unReadSeller ?? 0,
                        ));
                  });
    });
  }
          ...
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) => ChatScreen(
                ...
                messenger_name: controller.buyerChatList[index].shop_name!,
                messenger_title: controller.buyerChatList[index].title,
                messenger_image: controller.buyerChatList[index].shop_logo,
              ),
            ),
          );
        },
