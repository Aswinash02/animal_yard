...
class _CartState extends State<Cart> {
  ...
  getSetCartTotal() {
    _cartTotalString = _shopResponse!.grandTotal!;
    // .replaceAll(
  ...
  onPressProceedToShipping() async {
    _loadingState = true;
    setState(() {});
    await process(mode: "proceed_to_shipping");
    _loadingState = false;
    setState(() {});
  }

  Future<void> process({mode}) async {
    var cart_ids = [];
    var cart_quantities = [];
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Text(
                            convertPrice(_shopList[seller_index]
                                .cartItems[item_index]
                                .price),
