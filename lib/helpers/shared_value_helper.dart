...
final SharedValue<int?> user_otp = SharedValue(
  value: 0, // initial value
  key: "user_otp", // disk storage key for shared_preferences
);
...
final SharedValue<bool> last_viewed_product_status = SharedValue(
  value: false, // initial value
  key: "last_viewed_product_activation", // disk storage key for shared_preferences
);
